# -*- coding: utf-8 -*-
"""sentiment_analysis new Cluster 3-Moto Samsung.ipynb
...
opp_df = pd.DataFrame({'Sentences' : one_sentences, 'Model' : 'Moto X Play', 'Label' : '0'} )
...
sam_df = pd.DataFrame({'Sentences' : sam_sentences, 'Model' : 'Samsung Galaxy A8', 'Label' : '0'} )
