...
AZ5_df = pd.DataFrame({'Sentences' : AZ5_sentences, 'Model' : 'Asus Zenphone 5', 'Label' : 3} )
...
MX_df = pd.DataFrame({'Sentences' : MX_sentences, 'Model' : 'Motorola Moto X', 'Label' : 3} )
...
oneplus_df = pd.DataFrame({'Sentences' : one_sentences, 'Model' : 'One Plus X', 'Label' : 2} )
...
ZTE_df = pd.DataFrame({'Sentences' : ZTE_sentences, 'Model' : 'ZTE Star 2', 'Label' : 2} )
